...
// Fix: Define local aliases for intrinsic Three.js elements to resolve JSX type errors
...
const MacroscopicWave = () => {
  ...
  return (
    <Torus ref={ref} args={[3, 0.1, 16, 100]} rotation={[Math.PI / 2, 0, 0]}>
      {/* Fix: Use MeshStandardMaterial alias instead of intrinsic tag */}
  ...
  return (
    <div className="absolute inset-0 z-0 opacity-60 pointer-events-none">
      <Canvas camera={{ position: [0, 0, 6], fov: 45 }}>
        {/* Fix: Use AmbientLight and PointLight aliases instead of intrinsic tags */}
  ...
  return (
    <div className="w-full h-full absolute inset-0">
      <Canvas camera={{ position: [0, 0, 4.5], fov: 45 }}>
        {/* Fix: Use light aliases instead of intrinsic tags */}
        ...
        <Float rotationIntensity={0.4} floatIntensity={0.2} speed={1}>
          {/* Fix: Use Group alias instead of intrinsic tag */}
